...
open class StaticTableViewDataSource {

    open var sections: [StaticTableViewSection] = []
    ...
    open var selectedRows: [StaticTableViewRow] {
        get {
            var selectedRows: [StaticTableViewRow] = []
    ...
    open subscript(index: Int) -> StaticTableViewSection {
        get {
    ...
    open subscript(indexPath: IndexPath) -> StaticTableViewRow {
        get {
    ...
    open func section(at index: Int) -> StaticTableViewSection {
        return sections[index]
    }
    
    open func row(at indexPath: IndexPath) -> StaticTableViewRow {
        return sections[(indexPath as NSIndexPath).section].rows[(indexPath as NSIndexPath).row]
    }
    ...
    open func index(for aSection: StaticTableViewSection) -> Int? {
    ...
    open func indexPath(for aRow: StaticTableViewRow) -> IndexPath? {
    ...
    open func insert(_ section: StaticTableViewSection, at index: Int, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func insert(_ section: StaticTableViewSection, before beforeSection: StaticTableViewSection, with rowAnimation: UITableViewRowAnimation = .automatic) {
        if let index = index(for: beforeSection) {
            insert(section, at: index, with: rowAnimation)
        }
    }
    
    open func insert(_ section: StaticTableViewSection, after afterSection: StaticTableViewSection, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func delete(_ section: StaticTableViewSection, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func insert(_ row: StaticTableViewRow, at indexPath:IndexPath, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func insert(_ row: StaticTableViewRow, before beforeRow: StaticTableViewRow, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func insertRow(_ row: StaticTableViewRow, after afterRow: StaticTableViewRow, with rowAnimation: UITableViewRowAnimation = .automatic) {
    ...
    open func delete(_ row: StaticTableViewRow, with rowAnimation: UITableViewRowAnimation = .automatic) {
        if let indexPath = indexPath(for: row) {
...
private class UpdatedSection: StaticTableViewSection {
    var originalSection: StaticTableViewSection
    var index: Int
    var updateAction: DataSourceUpdateAction
    var rowAnimation: UITableViewRowAnimation
    
    init(originalSection: StaticTableViewSection, index: Int, updateAction: DataSourceUpdateAction, rowAnimation: UITableViewRowAnimation) {
...
private class UpdatedRow: StaticTableViewRow {
    var originalRow: StaticTableViewRow
    var indexPath: IndexPath
    var updateAction: DataSourceUpdateAction
    var rowAnimation: UITableViewRowAnimation
    
    init(originalRow: StaticTableViewRow, indexPath: IndexPath, updateAction: DataSourceUpdateAction, rowAnimation: UITableViewRowAnimation) {
