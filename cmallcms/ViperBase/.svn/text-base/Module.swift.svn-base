...
public struct Module {
    ...
    public static func build(_ module: String, bundle: Bundle = Bundle.main, deviceType: UIUserInterfaceIdiom? = nil, fromStoryBoard: Bool = false) -> Module {
        //Get class types
        ...
        var V: UserInterface? = nil
        if fromStoryBoard {
            V = loadView(forModule: module, bundle: bundle, deviceType: deviceType)
        }
        else {
            let ViewClass = module.classForViperComponent(.view, bundle: bundle, deviceType: deviceType) as! UIViewController.Type
            V = ViewClass.init() as? UserInterface
        }
...
fileprivate extension Module {
    ...
    fileprivate static func loadView(forModule module: String, bundle: Bundle, deviceType: UIUserInterfaceIdiom? = nil) -> UserInterface {
        let viewClass = module.classForViperComponent(.view, bundle: bundle, deviceType: deviceType) as! UIViewController.Type
        let sb = UIStoryboard(name: module.uppercasedFirst, bundle: bundle)
...
fileprivate extension String {
    ...
    fileprivate func classForViperComponent(_ component: ViperComponent, bundle: Bundle, deviceType: UIUserInterfaceIdiom? = nil) -> Swift.AnyClass? {
        let className = self.uppercasedFirst + component.rawValue.uppercasedFirst
